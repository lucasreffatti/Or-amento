...
export default async function ChecklistsPage() {
 ...
 <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-neutral-100 dark:border-[#222222]/50">
 <div>
 ...
 <div className="border border-neutral-200 dark:border-[#222222] bg-white dark:bg-[#111111] rounded-lg shadow-sm overflow-hidden">
 {checklists.length === 0 ? (
 <div className="p-12 flex flex-col items-center justify-center text-center">
 <div className="w-12 h-12 bg-neutral-50 dark:bg-black/50 rounded-full flex items-center justify-center mb-4 border border-neutral-100 dark:border-[#222222]/50">
 ...
 <thead className="bg-neutral-50 dark:bg-black/50/50">
 <tr>
