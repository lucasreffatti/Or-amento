...
import { Receipt, FileText, Send, CheckCircle2, XCircle, AlertCircle, Eye, Download, ShieldCheck, Settings, RefreshCw, Key, Building2 } from 'lucide-react'
            ...
            <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-bold text-white">
                  Espelho da Nota Fiscal - {selectedInvoice.number ? `Nº ${selectedInvoice.number}` : 'Rascunho'}
                </h2>
              </div>
              <button
                ...
                <div className="border-t border-neutral-800 pt-2 space-y-1">
                  ...
                  {selectedInvoice.protocol && (
                    <p className="text-[11px] text-neutral-400 font-mono">
                      Protocolo de Autorização: <span className="text-white">{selectedInvoice.protocol}</span>
                    </p>
                  )}
                </div>
              )}
