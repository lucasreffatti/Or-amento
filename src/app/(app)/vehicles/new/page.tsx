...
export default async function NewVehiclePage() {
 ...
 <div className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] rounded-lg shadow-sm p-4 sm:p-6">
 ...
 {customers.length === 0 ? (
 <div className="py-8 text-center bg-neutral-50 dark:bg-black/50 border border-neutral-100 dark:border-[#222222]/50 rounded-md">
 ...
 className="w-full px-3 py-2 bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] rounded-md text-sm outline-none focus:border-neutral-400 focus:ring-1 focus:ring-neutral-400 transition-all placeholder:text-neutral-400 dark:text-neutral-500 font-mono uppercase"
 />
 </div>
