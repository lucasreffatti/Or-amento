...
export default async function VehicleProfilePage(props: { params: Promise<{ id: string }> }) {
 ...
 <span className="font-mono text-neutral-700 dark:text-neutral-300 font-bold tracking-widest text-[13px] bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] px-2 py-1 rounded-md shadow-sm">
 {vehicle.plate}
 </span>
 </div>
 ...
 <Link href={`/customers/${vehicle.customerId}`} className="col-span-1 md:col-span-3 bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] rounded-xl p-6 hover:border-neutral-300 transition-colors group flex items-start gap-4">
 ...
 {vehicle.notes && (
 <div className="col-span-1 md:col-span-3 bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] rounded-xl p-6">
