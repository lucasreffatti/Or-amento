...
export default async function VehicleProfilePage(props: { params: Promise<{ id: string }> }) {
 ...
 {vehicle.notes && (
 <div className="col-span-1 md:col-span-3 bg-white border border-neutral-200 rounded-xl p-6">
 <h3 className="text-[11px] font-semibold text-neutral-400 uppercase tracking-widest mb-3">Observações do Veículo</h3>
 <p className="text-sm text-neutral-700 whitespace-pre-wrap">{vehicle.notes}</p>
 </div>
 )}
 </div>
