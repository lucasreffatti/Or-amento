...
export default async function VehiclesPage() {
 ...
 {vehicles.length === 0 ? (
 <div className="p-16 flex flex-col items-center justify-center text-center bg-neutral-50 ">
 ...
 {vehicles.map((v) => (
 <tr key={v.id} className="hover:bg-neutral-50 transition-colors group cursor-pointer">
 <td className="px-6 py-4 whitespace-nowrap">
 <Link href={`/vehicles/${v.id}`} className="hover:opacity-80">
 <span className="font-mono text-neutral-900 font-bold tracking-widest text-[13px] bg-neutral-100 border border-neutral-200 px-2.5 py-1 rounded-md shadow-sm">
 {v.plate}
 </span>
 </Link>
 </td>
