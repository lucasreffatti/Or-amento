...
export default async function VehiclesPage() {
 ...
 <tr>
 <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-[#222222]/50 whitespace-nowrap">Placa</th>
 <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-[#222222]/50 whitespace-nowrap">Modelo / Marca</th>
 <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-[#222222]/50 whitespace-nowrap">Proprietário</th>
 ...
 {vehicles.map((v) => (
 <tr key={v.id} className="hover:bg-neutral-50 dark:bg-black/50/80 transition-colors group cursor-pointer">
 <td className="px-6 py-4 whitespace-nowrap">
 <Link href={`/vehicles/${v.id}`} className="hover:opacity-80">
 <span className="font-mono text-neutral-900 dark:text-neutral-50 font-bold tracking-widest text-[13px] bg-neutral-100 border border-neutral-200 dark:border-[#222222]/80 px-2.5 py-1 rounded-md shadow-sm">
 {v.plate}
 </span>
 </Link>
 </td>
