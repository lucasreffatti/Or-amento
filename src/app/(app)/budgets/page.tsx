...
export default async function BudgetsPage(props: { searchParams: Promise<{ status?: string, type?: string }> }) {
 ...
 {/* Tabs */}
 <div className="flex gap-1 overflow-x-auto pb-2 scrollbar-hide border-b border-neutral-200 mt-4">
 {tabs.map(tab => {
 ...
 displayStatus === 'DRAFT' ? 'bg-neutral-50 text-neutral-600 border border-neutral-200 ' :
