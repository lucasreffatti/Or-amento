...
export default async function BudgetsPage(props: { searchParams: Promise<{ status?: string, type?: string }> }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
        ...
        <Link 
          ...
          className={`px-5 py-2 text-[13px] font-medium rounded-md transition-colors ${
            typeFilter === 'INTERNAL' 
              ...
              : 'bg-white dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:bg-neutral-950/50 border border-neutral-200 dark:border-neutral-800'
          }`}
        >
      ...
      {/* Tabs */}
      <div className="flex gap-1 overflow-x-auto pb-2 scrollbar-hide border-b border-neutral-200 dark:border-neutral-800/60 mt-4">
        {tabs.map(tab => {
          ...
          return (
            <Link 
              ...
              className={`flex items-center gap-2 px-4 py-2 text-[13px] font-medium rounded-t-lg transition-colors border-b-2 ${
                isActive 
                  ? 'border-neutral-900 text-neutral-900 dark:text-neutral-50 bg-neutral-50 dark:bg-neutral-950/50/50' 
                  : 'border-transparent text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:bg-neutral-950/50/50'
              }`}
            >
              {tab.icon}
              {tab.label}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-neutral-200/80 text-left text-sm">
              <thead className="bg-white dark:bg-neutral-900">
                <tr>
                  <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-neutral-800/50 whitespace-nowrap">Status</th>
                  <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-neutral-800/50 whitespace-nowrap">Cliente/Veículo</th>
                  <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-neutral-800/50 whitespace-nowrap">Valor Final</th>
                  <th className="px-6 py-4 font-semibold text-neutral-500 dark:text-neutral-400 text-[11px] uppercase tracking-widest border-b border-neutral-100 dark:border-neutral-800/50 text-right whitespace-nowrap">Validade</th>
              ...
              <tbody className="divide-y divide-neutral-100 bg-white dark:bg-neutral-900">
                {budgets.map((b) => {
                  ...
                  return (
                    <tr key={b.id} className="hover:bg-neutral-50 dark:bg-neutral-950/50/80 transition-colors group">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-[11px] font-mono font-medium shadow-sm ${
                          displayStatus === 'DRAFT' ? 'bg-neutral-50 dark:bg-neutral-950/50 text-neutral-600 dark:text-neutral-400 border border-neutral-200 dark:border-neutral-800/80' :
