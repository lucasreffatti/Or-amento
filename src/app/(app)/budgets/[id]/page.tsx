...
export default async function BudgetDetailsPage(props: { params: Promise<{ id: string }> }) {
 ...
 <div className="transform -rotate-12 border-[10px] border-neutral-500/5 text-neutral-500 rounded-3xl px-10 py-4 text-7xl md:text-8xl font-black uppercase tracking-widest">
 PENDENTE
 </div>
 )}
 {displayStatus === 'APPROVED' && (
