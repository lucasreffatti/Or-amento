...
export default async function BudgetDetailsPage(props: { params: Promise<{ id: string }> }) {
 ...
 <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-neutral-200 dark:border-[#222222]/60">
 ...
 <div className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] text-neutral-400 dark:text-neutral-500 px-3 py-1.5 rounded-md text-[13px] font-medium shadow-sm flex items-center gap-1.5 cursor-not-allowed">
 ...
 <form action={reject}>
 <button type="submit" className="bg-white dark:bg-[#111111] border border-red-200 text-red-600 px-3 py-1.5 rounded-md text-[13px] font-medium shadow-sm hover:bg-red-50 transition-colors flex items-center gap-1.5">
 ...
 <button type="submit" className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] text-neutral-600 dark:text-neutral-400 px-3 py-1.5 rounded-md text-[13px] font-medium shadow-sm hover:bg-neutral-50 dark:bg-black/50 transition-colors">
 Reabrir
 </button>
 </form>
 )}

 <Link href={`/budgets/${budget.id}/edit`} className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222] text-neutral-600 dark:text-neutral-400 px-3 py-1.5 rounded-md text-[13px] font-medium shadow-sm hover:bg-neutral-50 dark:bg-black/50 transition-colors flex items-center gap-1.5">
 ...
 <Link href={`/checklists/${budget.checklistId}`} className="text-[12px] bg-white dark:bg-[#111111] border border-indigo-100 text-indigo-600 px-3 py-1 rounded hover:bg-indigo-50 transition-colors font-medium shadow-sm">
 Ver Documento
 </Link>
 </div>
 )}
