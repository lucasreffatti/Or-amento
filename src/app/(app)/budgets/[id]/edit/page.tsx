...
export default async function EditBudgetPage(props: { params: Promise<{ id: string }> }) {
 ...
 <header className="flex items-center gap-4 pb-6 border-b border-neutral-200 dark:border-[#222222]/60 mb-8">
 <Link 
 ...
 <form action={handleSave} className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222]/80 rounded-xl shadow-sm p-6 space-y-6">
 <div className="grid grid-cols-2 gap-6 p-4 bg-neutral-50 dark:bg-black/50/50 rounded-lg border border-neutral-100 dark:border-[#222222]/50">
 <div>
