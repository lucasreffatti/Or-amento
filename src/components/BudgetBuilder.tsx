...
export default function BudgetBuilder({ budget }: { budget: Budget }) {
 ...
 <section className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222]/80 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.04)] overflow-hidden">
 <div className="px-5 py-3.5 border-b border-neutral-100 dark:border-[#222222]/50 bg-neutral-50 dark:bg-black/50/50 flex justify-between items-center">
 ...
 labor.map(item => (
 <tr key={item.id} className={`group hover:bg-neutral-50 dark:bg-black/50/50 transition-colors ${item.id.startsWith('temp') ? 'animate-pulse opacity-70' : ''}`}>
 ...
 {/* Adicionar Novo Item */}
 <section className="bg-white dark:bg-[#111111] border border-neutral-200 dark:border-[#222222]/80 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.04)] p-5">
 ...
 <select name="type" className="w-full px-3 py-2 bg-neutral-50 dark:bg-black/50 border border-neutral-200 dark:border-[#222222] rounded-md text-[13px] text-neutral-900 dark:text-neutral-50 outline-none focus:border-neutral-400 focus:bg-white dark:bg-[#111111] focus:ring-2 focus:ring-neutral-100 transition-all">
 ...
 <input required type="text" name="description" placeholder="Ex: Troca de óleo" className="w-full px-3 py-2 bg-neutral-50 dark:bg-black/50 border border-neutral-200 dark:border-[#222222] rounded-md text-[13px] text-neutral-900 dark:text-neutral-50 outline-none focus:border-neutral-400 focus:bg-white dark:bg-[#111111] focus:ring-2 focus:ring-neutral-100 transition-all placeholder:text-neutral-400 dark:text-neutral-500" />
 </div>

 <div className="md:col-span-2 space-y-1.5">
 <label className="text-[10px] font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Qtd</label>
 <input required type="number" name="quantity" defaultValue={1} min={1} className="w-full px-3 py-2 bg-neutral-50 dark:bg-black/50 border border-neutral-200 dark:border-[#222222] rounded-md text-[13px] text-neutral-900 dark:text-neutral-50 outline-none focus:border-neutral-400 focus:bg-white dark:bg-[#111111] focus:ring-2 focus:ring-neutral-100 transition-all font-mono" />
 </div>

 <div className="md:col-span-2 space-y-1.5">
 <label className="text-[10px] font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Preço Unit.</label>
 <input required type="number" name="unitPrice" step="0.01" min="0" placeholder="0.00" className="w-full px-3 py-2 bg-neutral-50 dark:bg-black/50 border border-neutral-200 dark:border-[#222222] rounded-md text-[13px] text-neutral-900 dark:text-neutral-50 outline-none focus:border-neutral-400 focus:bg-white dark:bg-[#111111] focus:ring-2 focus:ring-neutral-100 transition-all font-mono" />
 </div>
 ...
 className="w-full bg-white dark:bg-[#111111] text-black py-2.5 rounded-lg text-[13px] font-semibold hover:bg-neutral-200 transition-colors flex items-center justify-center shadow-sm"
 >
 Gerar PDF Comercial
 </Link>
