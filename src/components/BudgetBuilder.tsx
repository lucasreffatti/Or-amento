...
export default function BudgetBuilder({ budget }: { budget: Budget }) {
 ...
 <section className="bg-white border border-neutral-200 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.04)] overflow-hidden">
 <div className="px-5 py-3.5 border-b border-neutral-100 bg-neutral-50 flex justify-between items-center">
 ...
 labor.map(item => (
 <tr key={item.id} className={`group hover:bg-neutral-50 transition-colors ${item.id.startsWith('temp') ? 'animate-pulse opacity-70' : ''}`}>
 ...
 {/* Adicionar Novo Item */}
 <section className="bg-white border border-neutral-200 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.04)] p-5">
